...
def prepare_near_constant_params(
    ...
    k4 = -b_factor / 4
    amplitude_contrast = torch.as_tensor(amplitude_contrast, device=device)
    ...
    return k1, k2, k3, k4, k5, yy2, xx2, xy, n4
...
def calculate_ctf_cached(
    ...
    k1, k2, k3, k4, k5, yy2, xx2, xy, n4 = prepare_near_constant_params(voltage, spherical_aberration,
                                                                        ...
                                                                        pixel_size, image_shape, rfft, fftshift, device)
    # derived quantities used in CTF calculation
    defocus_u = defocus + astigmatism
    defocus_v = defocus - astigmatism

...
from libtilt.shapes.soft_edge import _add_soft_edge_single_binary_image, add_soft_edge_2d
...
def test_add_soft_edge_single_binary_image():
    ...
    image[0, 0] = 1
    smoothed = _add_soft_edge_single_binary_image(image, smoothing_radius=smoothing_radius)

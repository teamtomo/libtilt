...
from libtilt.projection.project_real import project_real_2d, project_real_3d
...
def test_real_space_projection_3d():
    ...
    projection = project_real_3d(volume, rotation_matrices=rotation_matrix)
...
def test_real_space_projection_2d():
    ...
    projection = project_real_2d(image, rotation_matrices=rotation_matrix)
